...
The built-in validation gates allow users to define acceptance criteria for approximation quality (e.g., ``$\mathrm{capV/aabb} < 2.5$ for all links'') and check them programmatically.
...
The recommended workflow starts from the default configuration, proceeds through iterative metric inspection and parameter adjustment, and verifies improvement against the baseline at each step.
