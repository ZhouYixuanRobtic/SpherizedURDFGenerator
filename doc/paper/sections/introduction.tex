...
Simulators and planners---MuJoCo~\cite{todorov2012mujoco}, Drake~\cite{drake}, PyBullet~\cite{coumans2018pybullet}---support analytic collision geometries with closed-form distance computation, but generating such primitives from existing URDF descriptions remains unsolved.
...
Despite these advantages, no widely adopted tool automatically converts URDF mesh geometry into analytic capsule primitives with coverage guarantees.
