...
% ---- 5. Tooling Gap -%
While each component---convex decomposition, sphere-tree generation, and capsule fitting---has been addressed individually, no existing open-source toolchain integrates them into a single URDF-to-URDF pipeline with sidecar primitive parameter export, validation metrics, and presets for reproducible tuning. Our work fills this integration gap, producing immediately usable URDF output and analytically reusable primitive data.
