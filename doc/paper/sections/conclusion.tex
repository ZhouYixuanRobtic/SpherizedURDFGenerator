...
The main methodological contribution is the automatic capsule-fitting pipeline, which decomposes robot link meshes into coverage-preserving analytic capsule primitives through principal-axis sectioning, adaptive circle fitting, collinear merging, coverage-preserving growth, endpoint tightening, inflation-based splitting, and nested-capsule pruning.
...
While the current pipeline is entirely geometric, a learned approach could predict capsule configurations directly from mesh topology, potentially reducing runtime and improving robustness on complex shapes.
